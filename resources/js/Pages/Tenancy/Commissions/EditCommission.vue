...
watch(
    [() => props.counciliors, () => usersForm.users],
    () => {
        usersNotYetAdded.value = props.counciliors.filter(
            (availableUser) =>
                !usersForm.users.some(
                    (commissionUser) => commissionUser.id === availableUser.id
                )
        );
    },
    { immediate: true }
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="p-4 border rounded-lg">
            ...
            <p v-else class="text-gray-500 dark:text-gray-400 mt-4">
