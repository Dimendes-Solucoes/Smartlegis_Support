            ...
            <div class="mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <div class="mb-6">
                            <TextInput type="text" v-model="search" placeholder="Buscar por documento..."
                                class="w-full" />
                        </div>
                        ...
                        <div v-if="discussionData.discussions.data.length > 0 && discussionData.discussions.links.length > 3"
                            ...
                            <Link v-for="(link, index) in discussionData.discussions.links" :key="index"
                                :href="link.url || ''" class="px-4 py-2 text-sm"
