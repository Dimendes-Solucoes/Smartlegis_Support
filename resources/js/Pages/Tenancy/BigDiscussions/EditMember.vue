...
<template>
    <Head :title="`Inscritos - ${discussionData.discussion.quorum.session.name}`" />

    <AuthenticatedLayout>
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-6">
                    Inscritos na Grande Discussão: {{ discussionData.discussion.quorum.session.name }}
                </h1>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                ...
                                <tr v-if="discussionData.users.length === 0">
                                    <td colspan="2" class="px-6 py-10 text-center text-gray-500">Nenhum usuário inscrito.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
