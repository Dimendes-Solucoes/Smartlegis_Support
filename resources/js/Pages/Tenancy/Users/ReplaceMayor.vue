    ...
    <AuthenticatedLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div v-if="selectedOption === 'new' || props.mayors.length === 0">
                <div class="mb-4">
                    <ImageUploadWithCropper v-model="newUserForm.path_image" :error="newUserForm.errors.path_image" />
                </div>
            ...
            <div class="flex items-center justify-end mt-4">
                <PrimaryButton :class="{ 'opacity-25': newUserForm.processing || existingMayorForm.processing }"
