...
<template>
    ...
    <AuthenticatedLayout>
        <div class="flex justify-end mb-4">
            <TextButton :href="route('admin.create')"> Novo Administrador </TextButton>
        </div>
                ...
                >
                    <tr v-for="admin in props.admins" :key="admin.id">
                        ...
                        >
                            ...
                            <IconButton
                                @click="openConfirmDeleteModal(admin)"
                                color="red"
                                title="Deletar"
                                class="ml-1"
                            >
    ...
    <ConfirmDeletionModal
        :show="adminToDelete !== null"
        title="Deletar administrador"
        :message="`Tem certeza que deseja deletar o administrador '${adminToDelete?.name}'?`"
